...
# CellViT Inference (backbones: HIPT, SAM-H) for Patch-Wise Inference on private/public unlabeled Kidney dataset
...
class InferenceCellViTMoNuSegParser:
    def __init__(self) -> None:
        ...
        parser.add_argument(
            "--dataset_dir",
            type=str,
            help="This directory should contain PNG patches"
        )

        parser.add_argument(
            "--output_dir",
            type=str,
            help="This directory will store predictions"
        )
